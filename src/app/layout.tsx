          ...
          <nav className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white shadow-sm print:hidden">
            <div className="flex h-16 items-center px-6 max-w-7xl mx-auto w-full justify-between">
              <div className="flex items-center gap-8">
                <Link href={profile?.role === 'Customer' ? '/portal' : '/'} className="flex items-center gap-2 text-indigo-700 font-bold text-lg tracking-tight">
                ...
                {profile?.role !== 'Customer' ? (
                  ...
                  <div className="flex gap-6 font-medium text-sm text-slate-600 hidden md:flex">
                    <Link href="/portal" className="hover:text-indigo-600 transition-colors border-b-2 border-indigo-600 pb-1">My Dashboard</Link>
                    <Link href="/portal/loads" className="hover:text-indigo-600 transition-colors pb-1">My Loads</Link>
                  </div>
                )}
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
                  <div className="flex flex-col items-end hidden sm:flex">
                    <span className="text-xs font-bold text-slate-900 leading-none">{profile?.first_name}</span>
